...
{
    public class MirrorShot : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Color sparkleColor = Color.Lerp(Color.LightBlue, Color.Cyan, Main.rand.NextFloat());
        ...
        public override void AI()
        {
            ...
            {
                int num9 = Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, 15, 0f, 0f, 100, default(Color), 2f);
