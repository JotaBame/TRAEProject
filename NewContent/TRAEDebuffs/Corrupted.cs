    ...
    public class Corrupted : TRAEDebuff
    {
        ...
        public override void Update(NPC npc)
        {
            ...
            if (ScourgeTime >= TinyEaterDelay)
            {
                ...
                for (int i = 0; i < TinyEaterCount; ++i)
                {
                    ...
                    Projectile.NewProjectile(npc.GetSpawnSourceForProjectileNPC(), npc.Center.X, npc.Center.Y, velX, velY, ProjectileID.TinyEater, 52, 0f, Main.myPlayer, 0f, 0f);
                }
            }
        }
        ...
        public override void CheckDead(NPC npc)
        {
            for (int i = 0; i < 3; ++i)
            {
                ...
                Projectile.NewProjectile(npc.GetSpawnSourceForProjectileNPC(), npc.position.X, npc.position.Y, velX, velY, ProjectileID.TinyEater, 52, 0f, Main.myPlayer, 0f, 0f);
            }
        }
    }
}
