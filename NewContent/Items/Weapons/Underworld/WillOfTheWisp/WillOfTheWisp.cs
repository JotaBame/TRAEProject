...
namespace TRAEProject.NewContent.Items.Weapons.Underworld.WillOfTheWisp
{
    ...
    public class WillOfTheWispFlame : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, Projectile.velocity.X * -0.33f, Projectile.velocity.Y * -0.33f, 0, default, 0.7f);
            ...
            if (num6 > 0)
            {
                ...
                float scaleFactor2 = 10f/*Projectile.velocity.Length()*/;
                value2.Normalize();
