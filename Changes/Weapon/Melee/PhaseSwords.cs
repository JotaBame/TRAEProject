...
namespace TRAEProject.Changes.Weapon
{
    ...
    class PhaseSwordPlayer : ModPlayer
    {
        public int swingDirection = -1;
    }
    class PhaseSwordProjectile : ModProjectile
    {
    ...
    class PhaseBladeProjectile : PhaseSwordProjectile
    {
    ...
    class PhaseSaberProjectile : PhaseSwordProjectile
    {
