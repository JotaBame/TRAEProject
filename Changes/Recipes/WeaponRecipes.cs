...
namespace TRAEProject.Changes.Recipes
{
    public static class WeaponRecipes
    {
        public static void Load()
        {
            ...
            Recipe SuperRocket = Recipe.Create(ItemID.RocketIII, 80);
            SuperRocket.AddIngredient(ItemID.RocketI, 80);
            SuperRocket.AddIngredient(ItemID.CobaltBar, 1);
            SuperRocket.AddTile(TileID.Anvils);
            SuperRocket.Register(); 
			Recipe SuperRocket2 = Recipe.Create(ItemID.RocketIII, 80);
            SuperRocket2.AddIngredient(ItemID.RocketI, 80);
