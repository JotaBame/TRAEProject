...
namespace TRAEProject.Changes.NPCs.Boss
{
        ...
        public static void Rotate(NPC npc)
        {
            ...
            if (npc.ai[0] > 5)
            {
                if (periodicTimer > startTime)
                {
                    ...
                    npc.rotation += (float)(periodicTimer - startTime) / 400f;  
    ...
    static void SetupTeleport(NPC npc)
        ...
        public static void DrawLaser(NPC npc, SpriteBatch spriteBatch)
        {
            ...
            bool secondLaserFired = npc.ai[2] % periodTime > tpCount * tpTime + firstShotDelay + shotTime * shotCount;
            float opacity = secondLaserFired ? 0 : 1;
    ...
    public class EyeNuke : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            { 
                ...
                Projectile.rotation.SlowRotation(flytowards - MathF.PI / 2, MathF.PI / 45f);
